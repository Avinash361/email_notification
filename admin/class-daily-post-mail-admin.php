 ...
 * @subpackage Daily_Post_Mail/admin
 */
...
class Daily_Post_Mail_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/daily-post-mail-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/daily-post-mail-admin.js', array( 'jquery' ), $this->version, false );
